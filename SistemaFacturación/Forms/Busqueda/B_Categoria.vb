...
Namespace SistemaFacturacion.Forms.Busqueda
    Partial Public Class B_Categoria
        ...
        Private Sub BTN_NMarca_Click(sender As Object, e As EventArgs) Handles BTN_SelectCat.Click
            ...
            Try
                ...
                If TypeOf (Owner) Is C_Productos Then
                    ...
                    frmProd.TXT_BuscarCat.Text = TXT_Nombre.Text
                ElseIf TypeOf (Owner) Is E_NuevoProducto Then
                    Dim frmNProd As E_NuevoProducto = CType(Owner, E_NuevoProducto)
                    frmNProd.TXT_Categoria.Text = TXT_Nombre.Text
                    frmNProd.LBL_IDCat.Text = DGV_BCat.SelectedRows(0).Cells(0).Value.ToString()
                Else
