...
Namespace SistemaFacturacion.Forms.Dialogos
    ...
    Public Class D_CalcularSaldoSiguiente
        ...
        Public Sub New(saldo As Cls_SaldoCaja)
            InitializeComponent()
            Me.saldoSiguiente = saldo
        End Sub

        Private Sub BTN_InsertarSaldo_Click(sender As Object, e As EventArgs) Handles BTN_InsertarSaldo.Click
            ' Si la validación es exitosa, establece el resultado y cierra el formulario.
            Me.ResultadoDelDialogo = DialogResult.OK
            Me.Close()
        End Sub

        Private Sub D_CalcularSaldoSiguiente_Load(sender As Object, e As EventArgs) Handles MyBase.Load
