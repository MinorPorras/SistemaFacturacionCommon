...
Namespace SistemaFacturacion.Forms.Dialogos
    ...
    Public Class D_VerDatosCierre
        ...
        Private Sub D_VerDatosCierre_Load(sender As Object, e As EventArgs) Handles MyBase.Load
            TXT_VerCCSaldoInicial.Text = datosCierre.saldo_inicial.ToString("C", New CultureInfo("es-CR"))
            ...
            Dim totalEsperado = CInt(datosCierre.saldo_inicial) + CInt(datosCierre.ingresoEfectivo) - CInt(datosCierre.salidasEfectivo)
